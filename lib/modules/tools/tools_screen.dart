...
import '../../models/products/tools_model.dart';
...
class ToolsScreen extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            ConditionalBuilder(
              condition: LavieCubit.get(context).toolsModel != null,
              builder: (context) => buildHome(LavieCubit.get(context).toolsModel!, context),
  ...
  Widget buildHome(ToolsModel model, context) => GridView.count(
    crossAxisCount: 2,
    ...
    children: List.generate(
      LavieCubit.get(context).toolsModel!.data!.length,
          (index) => buildGridItem(
          LavieCubit.get(context).toolsModel!.data![index]),
    ),
  );

  Widget buildGridItem(ToolsData model) => Padding(
