...
import 'package:la_vie/modules/my_cart/my_cart_screen.dart';
import 'package:la_vie/modules/seeds/seeds_screen.dart';
import 'package:la_vie/modules/tools/tools_screen.dart';
...
class ProductsScreen extends StatelessWidget {
              ...
              children: [
                ...
                ConditionalBuilder(
                  ...
                  builder: (BuildContext context) =>
                      buildHome(LavieCubit.get(context).productsModel!, context),
  ...
  Widget buildHome(ProductsModel model, context) => GridView.count(
        crossAxisCount: 2,
        ...
        children: List.generate(
          LavieCubit.get(context).productsModel!.data!.length,
          (index) => buildGridItem(
              LavieCubit.get(context).productsModel!.data![index]),
        ),
      );

  Widget buildGridItem(ProductsData model) => Padding(
